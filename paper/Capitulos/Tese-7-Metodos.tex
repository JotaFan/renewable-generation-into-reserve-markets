...
\thispagestyle{plain}
\input{Capitulos/Tese-7-Metodos-Estatisticos} \label{se:metstats}


\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-7-Metodos-Redes_neuronais} \label{se:metneuralnet}

\thispagestyle{plain}
\input{Capitulos/Tese-7-Metodos-validacao_benchmark}
