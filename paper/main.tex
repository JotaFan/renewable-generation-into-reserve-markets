...
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-4-Estudo_2} \label{ch:estudo_2}


% Arquiteturas a estudar
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-5-Arquitecturas_de_Modelos}\label{ch:arch}
% Ferramentas
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-6-Ferramentas}\label{ch:ferramentas}
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-7-Metricas}\label{ch:metricas}

% Métodos
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-7-Metodos}\label{ch:metodos}
% Resultados e discussão
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-8-Resultados_discussao}\label{ch:resultados_discussao}
% Conclusões e sugestões futuras
\newpage
\thispagestyle{plain}
\include{Capitulos/Tese-9-Conclusao}\label{ch:conclusao}
...
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-10-Anexos}
\label{ch:Anexos}
