...
% \begin{figure}[H]
% 	\centering
% 	\resizebox{\linewidth}{!}{\input{../../dissertation/graphs/mibel.tex}}
...
\begin{table}[H]
    ...
    \resizebox{!}{!}{\input{../../dissertation/tabelas/tabela_media_banda_portugal.tex}}
...
\begin{table}[H]
    ...
    \resizebox{!}{!}{\input{../../dissertation/tabelas/tabela_media_banda_espanha.tex}}
