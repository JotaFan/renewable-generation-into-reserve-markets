...
\begin{figure}[H]
	\centering
	\resizebox{0.7\linewidth}{!}{\input{../../dissertation/graphs/neuronio.tex}}
...
\begin{figure}[H]
	\centering
	\resizebox{0.7\linewidth}{!}{\input{../../dissertation/graphs/conv1D.tex}}
...
\begin{figure}[H]
	\centering
	\resizebox{0.7\linewidth}{!}{\input{../../dissertation/graphs/conv_layer.tex}}
...
\begin{figure}[H]
	\centering
	\resizebox{\linewidth}{!}{\input{../../dissertation/graphs/unet.tex}}
