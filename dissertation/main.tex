...
% \usepackage{etoolbox} % Ensure this package is loaded
% \AtBeginEnvironment{table}{\small} % Apply \small or any other size you prefer
% \DeclareCaptionFont{tablesize}{\fontsize{9}{10}\selectfont} % Adjust sizes as needed
% \captionsetup[table]{font=tablesize}
...
% \usepackage{babel} %Can be switched to english
...
\newpage
\thispagestyle{empty}
\includepdf{capa.pdf}\label{Capa}
...
\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-5-Ferramentas_Metodos} \label{ch:ferr_met}

\newpage
\thispagestyle{plain}
\input{Capitulos/Tese-5-Metricas_Dados} \label{ch:metrics_data}
