...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{plots/histograma_parametro_p.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plots/comparação_de_ρ_propostos_por_hora.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{plots/comparação_das_metricas_de_erro.png}
