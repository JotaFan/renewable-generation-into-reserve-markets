...
O erro será diferença entre a \textit{BR} calculada a partir do $\rho_{proposto}$ e do consumo real, e a \text{BR} calculada pela \gls{REN}. A normalização que apresentar um menor erro é escolhida.\par
